  ...
  return (
    <footer className="bg-[#2C1810] text-[#F7F0E6]">
      <div className="container-site py-12 md:py-16">
        ...
        {/* Нижний блок */}
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-[13px] text-white/40">
          <p>© {year} Ольга Куркина. Все права защищены.</p>
          <p className="text-[12px]">
            * Instagram — продукт Meta, признанной в РФ экстремистской организацией
          </p>
        </div>
