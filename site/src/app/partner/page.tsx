...
const FAQ = [
  ...
  },
  {
    ...
    a: "Я начинала как учитель, потом перешла в коммерцию и за 10 лет выросла до генерального директора. Этот управленческий опыт очень помог, но в онлайн-бизнесе пришлось учиться заново.",
  },
  {
