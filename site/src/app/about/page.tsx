...
const TIMELINE = [
  ...
  },
  {
    ...
    text: "Серьёзное аутоиммунное заболевание. Базисная терапия, гормоны, метотрексаты. Потеря энергии, сил, мотивации. Врачи сказали: «Пожизненно».",
    accent: true,
  },
  {
    period: "Через 2–4 месяца",
    title: "Клеточное питание и восстановление",
    text: "Узнала о продукции Адженис. Решила попробовать. Через 2–4 месяца — значительное улучшение. Анализы пришли в норму. Приняла решение развиваться в этом направлении.",
    accent: false,
  },
  {
    period: "Новый этап",
